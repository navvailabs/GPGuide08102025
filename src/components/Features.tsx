...
const Features = () => {
    ...
    return (
        <section className="py-20 sm:py-24 bg-gray-50 dark:bg-medical-blue">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-50 dark:to-neutral-400">Everything You Need for Practice Excellence</h2>
                    ...
                    {primaryFeatures.map((feature, index) => (
                        ...
                        >
                            <InspiredCard className="p-8 flex flex-col h-full">
                                <div className="relative w-16 h-16 bg-medical-blue/10 dark:bg-medical-blue/50 border border-gray-200 dark:border-white/20 rounded-full flex items-center justify-center mb-6">
                                    <div className="absolute -inset-2 bg-cyan-400/20 rounded-full blur-md animate-pulse"></div>
                                    <feature.icon className="relative w-8 h-8 text-medical-blue dark:text-cyan-300" />
                                </div>
                                <h3 className="text-2xl font-bold text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-50 dark:to-neutral-400">{feature.title}</h3>
                                <p className="mt-2 text-gray-600 dark:text-gray-300 flex-grow">{feature.description}</p>
                                <ul className="mt-6 space-y-4">
                                    {feature.points.map(point => (
                                        <li key={point} className="flex items-start">
                                            <CheckCircle className="h-5 w-5 text-cyan-500 dark:text-cyan-400 mr-3 mt-0.5 flex-shrink-0" />
                ...
                >
                    <h3 className="text-3xl font-bold mb-8 text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-50 dark:to-neutral-400">Transform Your Practice Starting Today</h3>
                    <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {achievements.map((item) => (
                            <InspiredCard key={item.title} className="p-6 text-center">
