...
import FlowingGradientBackground from './ui/FlowingGradientBackground';
...
const Hero = () => {
    ...
    return (
        <section className="relative w-full font-body text-text-secondary dark:text-gray-300 bg-medical-blue">
