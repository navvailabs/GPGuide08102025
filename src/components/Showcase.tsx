...
const Showcase = () => {
    ...
    return (
        <section id="testimonials" className="py-20 sm:py-24 bg-white dark:bg-medical-blue">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-50 dark:to-neutral-400">Professional Templates That Save Time</h2>
                    ...
                    <AnimatePresence initial={false} custom={direction}>
                        ...
                        >
                            ...
                            <div className="text-left">
                                <h3 className="text-2xl font-bold text-gray-900 dark:bg-clip-text dark:text-transparent dark:bg-gradient-to-b dark:from-neutral-50 dark:to-neutral-400">{currentTemplate.title}</h3>
                                ...
                                <button className="mt-6 bg-medical-blue text-white font-semibold py-2 px-6 rounded-lg hover:bg-opacity-90 transition-colors">
                                    View Full Template
                                </button>
                            </div>
                        </motion.div>
