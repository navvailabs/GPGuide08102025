    ...
    return (
        <section id="testimonials" className="py-20 sm:py-24 text-white">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <h2 className="text-mobile-h2 md:text-desktop-h2 font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">Professional Templates That Save Time</h2>
                    ...
                    <AnimatePresence initial={false} custom={direction}>
                        ...
                        >
                            ...
                            <div className="text-left">
                                <h3 className="text-2xl font-bold bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400">{currentTemplate.title}</h3>
