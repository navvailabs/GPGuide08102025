...
const VideoDemo = () => {
    const additionalDemos = [
        { title: "Mobile App Walkthrough", duration: "1:30", image: "https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x225/0F6E6E/FFFFFF?text=Mobile+App" },
        { title: "EMR Integration Demo", duration: "2:00", image: "https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x225/0F6E6E/FFFFFF?text=EMR+Integration" },
        { title: "Customization Options", duration: "1:45", image: "https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x225/0F6E6E/FFFFFF?text=Customization" },
        { title: "Team Features Overview", duration: "2:30", image: "https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/400x225/0F6E6E/FFFFFF?text=Team+Features" },
    ];
            ...
            <div className="container mx-auto px-4 sm:px-6 lg:px-8">
                ...
                >
                    <div className="relative aspect-video bg-black rounded-xl shadow-2xl overflow-hidden group">
                        <img src="https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://img-wrapper.vercel.app/image?url=https://placehold.co/1280x720/0A2540/FFFFFF?text=GP+Workflow+Demo" alt="GPGuide Demo Video" className="w-full h-full object-cover" />
