    ...
    const handleGeneratePreview = async () => {
        ...
        try {
            ...
            if (data && typeof data.output === 'string') {
                ...
                const sections = [];
                // Regex to capture a heading (in **) and its following content
                const regex = /\*\*(.*?)\*\*\s*([\s\S]*?)(?=\n\s*\*\*|$)/g;
                let match;
                ...
                while ((match = regex.exec(markdownContent)) !== null) {
                    ...
                    if (heading.toLowerCase().includes('crisis resources')) {
                        // Special handling for the crisis resources list
                        ...
                        // General content: split by double newlines for paragraphs
                ...
                if (sections.length > 0) {
                    ...
                    // Fallback if regex fails to parse sections
